...
const Menu = () => {
  ...
  useEffect(() => {
    setIsCollapsibles(Array(5).fill(false));
  }, []);
  return (
    <View className="w-full h-full bg-white text-black  relative">
      <View className="absolute w-full items-center justify-center bottom-1 left-0 z-10">
        <CustomButton
      ...
      <View className="w-full gap-2 p-4">
        <View className="mt-4">
          ...
          >
            <Tab.Item>
              <Text className="text-gray-900 text-md">Tab</Text>
            </Tab.Item>
                  ...
                  <View>
                    <View className="flex-row items-center gap-x-2">
                      <Text className="font-bold text-lg text-gray-800">
                        {i === 0 ? "Ăn sáng" : i === 1 ? "Ăn trưa" : "Ăn tối"}
                      </Text>
